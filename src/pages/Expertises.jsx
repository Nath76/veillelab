      ...
      <aside className="left-rail">
        ...
        <section className="rail-section expertise-intro">
          ...
          <p>
            ...
            de travaux sur les sujets relevant de ses domaines d’intervention.
            Il combine ainsi, d’une manière unique,{' '}
            <strong>culture de l’action</strong> et capacité collective à mettre
            en perspective les politiques publiques.
          </p>
          ...
          <p>
            ...
            (intérieure ; publique ; civile, routière), migrations et
            citoyenneté, protection des populations, anticipation et gestion
            des crises, cultes et laïcité, action publique territoriale.
          </p>
          ...
          <p>
            ...
            découvrir les savoir-faire spécifiques d’une large diversité de
            métiers.
          </p>
        </section>
