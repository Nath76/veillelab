  ...
  return <main className="page qvl-reco-v02">
    ...
    <section className="qvl-reco-scope">
      <div className="qvl-reco-fields">
        ...
        <div className="qvl-reco-field"><label>Sujet <span className="qvl-optional">OPTIONNEL</span> <Icon name="info" size={14}/></label><input type="text" value={subject} onChange={e=>{setSubject(e.target.value);setResults(null);setSelectedReco(null)}} placeholder="Laissez vide pour extraire toutes les recommandations du périmètre"/><small className="qvl-reco-helper">Facultatif : renseignez un sujet uniquement pour resserrer les résultats.</small></div>
